    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.create_subscription(
            Float32, "/LunarYard/Sun/Intensity", self.setSunIntensity, 1
        )
        ...
        self.create_subscription(
            Int32, "/LunarYard/Terrain/Switch", self.switchTerrain, 1
        )
        self.create_subscription(
            Bool, "/LunarYard/Terrain/EnableRocks", self.enableRocks, 1
        )
        self.create_subscription(
            Int32, "/LunarYard/Terrain/RandomizeRocks", self.randomizeRocks, 1
        )
        self.create_subscription(
            Empty, "/LunarYard/Render/EnableRTXRealTime", self.useRTXRealTimeRender, 1
        )
        self.create_subscription(
            Empty,
        ...
        self.create_subscription(
            Bool, "/LunarYard/LensFlare/EnableLensFlares", self.setLensFlareOn, 1
        )
        self.create_subscription(
            Int8, "/LunarYard/LensFlare/NumBlades", self.setLensFlareNumBlade, 1
        )
        self.create_subscription(
            Float32, "/LunarYard/LensFlare/Scale", self.setLensFlareScale, 1
        )
        self.create_subscription(
            Float32,
        ...
        self.create_subscription(
            Float32, "/LunarYard/LensFlare/FocalLength", self.setLensFlareFocalLength, 1
        )
        self.create_subscription(
            Float32, "/LunarYard/LensFlare/Fstop", self.setLensFlareFstop, 1
        )
        self.create_subscription(
            Float32,
