    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.create_subscription(
            Bool, "/Lunalab/Projector/TurnOn", self.setProjectorOn, 1
        )
        self.create_subscription(
            Float32, "/Lunalab/Projector/Intensity", self.setProjectorIntensity, 1
        )
        self.create_subscription(
            Float32, "/Lunalab/Projector/Radius", self.setProjectorRadius, 1
        )
        self.create_subscription(
            Pose, "/Lunalab/Projector/Pose", self.setProjectorPose, 1
        )
        # self.create_subscription(ColorRGBA, "/Lunalab/Projector/Color", self.setProjectorColor, 1)
        self.create_subscription(
            Bool, "/Lunalab/CeilingLights/TurnOn", self.setCeilingOn, 1
        )
        self.create_subscription(
            Float32, "/Lunalab/CeilingLights/Intensity", self.setCeilingIntensity, 1
        )
        ...
        self.create_subscription(
            Bool, "/Lunalab/Curtains/Extend", self.setCurtainsMode, 1
        )
        self.create_subscription(
            Int32, "/Lunalab/Terrain/Switch", self.switchTerrain, 1
        )
        self.create_subscription(
            Bool, "/Lunalab/Terrain/EnableRocks", self.enableRocks, 1
        )
        self.create_subscription(
            Int32, "/Lunalab/Terrain/RandomizeRocks", self.randomizeRocks, 1
        )
        self.create_subscription(
            Empty, "/Lunalab/Render/EnableRTXRealTime", self.useRTXRealTimeRender, 1
        )
        self.create_subscription(
            Empty,
        ...
        self.create_subscription(
            Bool, "/Lunalab/LensFlare/EnableLensFlares", self.setLensFlareOn, 1
        )
        self.create_subscription(
            Int8, "/Lunalab/LensFlare/NumBlades", self.setLensFlareNumBlade, 1
        )
        self.create_subscription(
            Float32, "/Lunalab/LensFlare/Scale", self.setLensFlareScale, 1
        )
        self.create_subscription(
            Float32,
        ...
        self.create_subscription(
            Float32, "/Lunalab/LensFlare/FocalLength", self.setLensFlareFocalLength, 1
        )
        self.create_subscription(
            Float32, "/Lunalab/LensFlare/Fstop", self.setLensFlareFstop, 1
        )
        self.create_subscription(
            Float32,
