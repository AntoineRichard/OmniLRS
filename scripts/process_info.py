...
def parse_args():
    ...
    parser.add_argument("--info_path", type=str, default="tmp/ldem_87s_5mpp.info", help="Path to DEM info")
    parser.add_argument("--output_dir", type=str, default="tmp", help="Path to save preprocessed info")
    parser.add_argument("--output_name", type=str, default="ldem_87s_5mpp", help="Name of the output file")
